...
var initImagesLoaded = function (e, t, n) {
    ...
    bgImgLoaded = function (e) {
        ...
        imagesLoaded(t, function () {
            ...
            if (null !== e) {
                var t = $(".main-header");
                $(".main-header").css("-image", "URL(" + e + ")"), app.isMobile() && t.backstretch(e)
            }
        })
    },
    ...
    initInfiniteScroll = function (e, t, n) {
        ...
        if (a.length > 0 && i.length > 0) {
            ...
            a = parseInt(o[1]), r = parseInt(r), $("#post-container .grid-container").infinitescroll({
                ...
                n.go(60), r += 1, n.go(90), r > a ? ($(window).unbind(".infscr"), $(".pagination").remove()) : i.attr("href", "/page/" + r + "/"), n.go(100)
            })
        }
    },
    keys = [37, 38, 39, 40];
